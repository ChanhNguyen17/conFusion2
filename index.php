            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="reserveForm">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline"><input type="radio" name="numberOfGuests">1</label>
                            <label class="radio-inline"><input type="radio" name="numberOfGuests">2</label>
                            <label class="radio-inline"><input type="radio" name="numberOfGuests">3</label>
                            <label class="radio-inline"><input type="radio" name="numberOfGuests">4</label>
                            <label class="radio-inline"><input type="radio" name="numberOfGuests">5</label>
                            <label class="radio-inline"><input type="radio" name="numberOfGuests">6</label>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="emailid" class="col-sm-2 control-label">Date and Time</label>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4 col-sm-offset-1">
                            <div class="input-group">
                                <input type="time" class="form-control" id="date" name="time" placeholder="Time">
        ...
        <div class="container">
            <div class="row row-header">
                ...
                <div class="col-xs-12 col-sm-2">
                    ...
                    id="reserveFormButton">Reverve Table</a>
                </div>
            </div>
        </div>
    </header>
